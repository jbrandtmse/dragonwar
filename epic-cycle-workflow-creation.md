...
| MED, fix-risk ≤ med, in-footprint (**in-story or in-epic** — the epic's footprint, not the story's) | Fix now (rework loop). Not deferrable; "the story that will touch it later" is not a disposition. |
