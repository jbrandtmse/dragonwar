...
//
// Ambient types for make-placeholder-glb.mjs's named exports, so
// test/make-placeholder-glb.test.ts (a .ts file, strict mode) can import them
...
export declare function buildPlaceholderGlb(): Buffer;
