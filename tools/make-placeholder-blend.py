...
def main():
	...
	# LOCK_CEILING_X_OVERLAP_W_MM/_E_MM [CORRECTED, Story 2.15, DW-151 -- no
	# such constant as LOCK_CEILING_X_OVERLAP_MM exists; the real ones are
	# the two named just below, both 4.0] past each leg's own lane-facing
	# face so its
